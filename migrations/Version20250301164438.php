 ...
 */
final class Version20250301164438 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tenant (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, mc_host VARCHAR(255) NOT NULL, domains JSON NOT NULL COMMENT \'(DC2Type:json)\', rcon_port INT DEFAULT NULL, rcon_password VARCHAR(255) DEFAULT NULL, registration_password VARCHAR(255) DEFAULT NULL, bedrock_port INT DEFAULT NULL, java_port INT DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_IDENTIFIER_TENANT_NAME (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
